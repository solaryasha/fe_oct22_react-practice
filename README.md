...
2. Implement ability to filter photos by an owner:
...
3. Use the `input` to filter photos by name.
...
5. Show `No results` message if there are no photos matching current criteria
...
- [DEMO LINK](https://AntonMartynes.github.io/react_product-categories-practice/)
